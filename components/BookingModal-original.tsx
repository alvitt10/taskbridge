  ...
  return (
    <>
      ...
      <div style={{ background: 'var(--accent-light)', borderRadius: 8, padding: '12px 16px', marginTop: 16, fontSize: 13, color: 'var(--accent2)' }}>
        🔒 Your payment of <strong>${(amount / 100).toFixed(2)}</strong> is held in escrow and only released once the job is complete.
      </div>
  ...
  return (
    <div style={{ textAlign: 'center', padding: '20px 0' }}>
      ...
      <p style={{ color: 'var(--muted)', fontSize: 15, marginBottom: 20 }}>
        Payment secured in escrow. The provider will confirm within 15 minutes.
      </p>
